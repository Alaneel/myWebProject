    ...
    public static void main(String[] args) {
        try (
            ...
            Connection conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/ebookshop?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC", "myuser", "!Wym031009"
            ); // for MySQL only
            ...
            // Step 3 & 4 (again): Ossie a SELECT (via executeQuery()) to check the UPDATE
